          ...
          <article className="mx-auto w-full max-w-3xl px-6 py-20">
            ...
            <div className="space-y-6">
              <p className="text-sm leading-relaxed text-[#52525B]">
                En Ópera Prima utilizamos cookies y tecnologías similares para garantizar el
                correcto funcionamiento de la plataforma, mejorar tu experiencia y analizar el uso
                que haces de nuestros servicios. Esta Política de Cookies explica qué son las
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-[#E4E4E7]">
                            ...
                            <th className="py-2 pr-4 text-left font-bold text-[#111]">
                              Descripción
                            </th>
              ...
              <section>
                ...
                <p className="text-sm leading-relaxed text-[#52525B]">
                  ...
                  configuración de tu navegador. A continuación te indicamos los enlaces a las
                  páginas de configuración de los navegadores más utilizados:
                </p>
              ...
              <section>
                ...
                <p className="text-sm leading-relaxed text-[#52525B]">
                  En Ópera Prima utilizamos servicios de terceros que pueden establecer cookies en
                  tu dispositivo. Estos terceros incluyen a Google Analytics (análisis de uso),
                  Supabase (autenticación y base de datos), Vercel (alojamiento) y Stripe
                  (procesamiento de pagos). Te recomendamos consultar sus respectivas políticas de
                  cookies para obtener información detallada sobre el tratamiento de tus datos.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm leading-relaxed text-[#52525B]">
                  ...
                  cambios en las cookies que utilizamos o en la normativa aplicable. Te
                  notificaremos cualquier cambio significativo a través de la plataforma o por
                  correo electrónico. Te recomendamos revisar esta página periódicamente para
