...
export const BLOCK_SCHEMAS: Record<string, BlockSchema> = {
  ...
  'events-comunidad': {
    ...
    category: 'Section',
    fields: [
      { key: 'eyebrow', label: 'Etiqueta', type: 'text', default: 'Eventos de la comunidad' },
      {
        key: 'headingLogged',
  ...
  'mentorias-landing': {
    ...
    fields: [
      ...
      { key: 'stepsEyebrow', label: 'Etiqueta pasos', type: 'text', default: '¿Cómo funcionan?' },
      {
        key: 'stepsHeading',
        label: 'Título pasos',
        type: 'richtext',
        default:
          'Un proceso claro para que cada sesión <span class="text-[#F65B7F]">tenga foco y resultado.</span>',
      },
      {
        key: 'steps',
        label: 'Pasos',
      ...
      {
        key: 'stepsCtaLoggedText',
        label: 'CTA pasos logueado',
        type: 'text',
        default: 'Ver mentores',
      },
      {
        key: 'stepsCtaGuestText',
        label: 'CTA pasos invitado',
        type: 'text',
        default: 'Reservar mentoría',
      },
      {
        key: 'ctaBlueHeading',
        label: 'Título CTA azul',
        type: 'richtext',
        default: 'Tu práctica artística merece un acompañamiento real.',
      },
      { key: 'ctaBlueDescription', label: 'Descripción CTA azul', type: 'richtext' },
      {
        key: 'ctaBlueLoggedText',
        label: 'CTA azul logueado',
        type: 'text',
        default: 'Ver mentores',
      },
      {
        key: 'ctaBlueGuestText',
        label: 'CTA azul invitado',
        type: 'text',
        default: 'Reservar mentoría',
      },
      {
        key: 'mentoresEyebrow',
        label: 'Etiqueta mentores',
        type: 'text',
        default: 'Nuestros mentores',
      },
      {
        key: 'mentoresHeading',
        label: 'Título mentores',
        type: 'richtext',
        default:
          'Profesionales listos para <span class="text-[#F65B7F]">impulsar tu camino.</span>',
      },
      {
        key: 'adminModeLabel',
        label: 'Label modo edición',
        type: 'text',
        default: 'Modo edición — Mentores',
      },
      {
        key: 'addMentorText',
        label: 'Texto agregar mentor',
        type: 'text',
        default: 'Agregar mentor',
      },
      {
        key: 'emptyMentorText',
        label: 'Texto sin mentores',
        type: 'text',
        default: 'Próximamente estaremos anunciando nuestros mentores.',
      },
      {
        key: 'ctaDarkEyebrow',
        label: 'Etiqueta CTA oscura',
        type: 'text',
        default: '¿Quieres ser mentor?',
      },
      { key: 'ctaDarkDescription', label: 'Descripción CTA oscura', type: 'richtext' },
      {
        key: 'ctaDarkButtonText',
        label: 'Botón CTA oscura',
        type: 'text',
        default: 'Escribir al equipo',
      },
    ],
    defaultProps: {},
  },
  ...
  'proyectos-section': {
    ...
    category: 'Section',
    fields: [
      { key: 'eyebrow', label: 'Etiqueta', type: 'text', default: 'Proyectos activos' },
      { key: 'heading', label: 'Título', type: 'richtext', default: 'Explora oportunidades' },
      {
        key: 'searchPlaceholder',
        label: 'Placeholder búsqueda',
        type: 'text',
      ...
      { key: 'emptyTitle', label: 'Título vacío', type: 'text', default: 'Sin resultados' },
      {
        ...
        label: 'Descripción vacía',
        type: 'richtext',
        default: 'No encontramos proyectos con esos criterios.',
      },
      { key: 'viewMoreText', label: 'Ver más', type: 'text', default: 'Ver más' },
      { key: 'viewMoreGuestText', label: 'Ver más invitado', type: 'text', default: 'Ver más →' },
      {
        key: 'contactTermsText',
        label: 'Texto términos',
        type: 'text',
        default: 'Al contactar, aceptas los términos de uso de Ópera Prima.',
      },
    ],
    defaultProps: {},
  },
